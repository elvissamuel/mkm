...
export default function PremiumUsersPage() {
  ...
  const { data: usersData, isLoading } = useQuery({
    queryKey: [QUERY_KEY.GET_ALL_USERS, "PREMIUM", page, limit, search],
    queryFn: () => getUsers(page, limit, "PREMIUM", search),
  })
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight text-[#c19b37]">Premium Users</h1>
